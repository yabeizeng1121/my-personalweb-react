...
function HamburgerIcon() {
  ...
  return (
    <div>
      <svg className={`ham ham3 ${isOpen ? 'active' : ''}`} viewBox="0 0 100 100" width="80" onClick={handleToggle}>
      ...
      {isOpen && (
        <div className="menu">
          <ul>
            <li><a onClick={() => handleMenuItemClick('/introduction')}>Introduction</a></li>
            <li><a onClick={() => handleMenuItemClick('/experience')}>Experience</a></li>
            <li><a onClick={() => handleMenuItemClick('/project')}>Project</a></li>
            <li><a onClick={() => handleMenuItemClick('/education')}>Education</a></li>
            <li><a onClick={() => handleMenuItemClick('/skills')}>Skills</a></li>
            <li><a onClick={() => handleMenuItemClick('/contact')}>Contact</a></li>
          </ul>
        </div>
      )}
    </div>
