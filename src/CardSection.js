      ...
      <div className="card-container">
        <div className="card-box">
          ...
          <div className="content">
            ...
            <button className="read-more-button" onClick={() => handleReadMoreClick(1)}>Read More</button>
          </div>
        </div>
        <div className="card-box">
          <span></span>
          <div className="content">
            ...
            {/* Replace <a> with <button> */}
            <button className="read-more-button" onClick={() => handleReadMoreClick(2)}>Read More</button>
          </div>
        </div>
        <div className="card-box">
          <span></span>
          <div className="content">
            ...
            {/* Replace <a> with <button> */}
            <button className="read-more-button" onClick={() => handleReadMoreClick(3)}>Read More</button>
          </div>
        </div>
        <div className="card-box">
          <span></span>
          <div className="content">
            ...
            {/* Replace <a> with <button> */}
            <button className="read-more-button" onClick={() => handleReadMoreClick(4)}>Read More</button>
          </div>
        </div>
      </div>
